...
| 5 | local learnings registry | `registry/local-learnings.yaml`, schema, intake tests | done: candidate packets + field_review/adopt fail-closed gates（既存 packet の decision は未変更） |

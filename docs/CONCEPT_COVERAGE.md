...
| Research / GitHub method | covered | `devbrain research`, `docs/AUTOPILOT_GOAL_DESIGN.md`, `reinvention_candidate_research_gate` | PR packet と closeout evidence へ接続する |
...
| Merge / branch cleanup | covered | `devbrain finish`, `tools/hooks/post-merge`, `docs/AUTOPILOT_GOAL_DESIGN.md` | remote cleanup は approval / identity gate を維持する |
...
4. `devbrain run --closeout` の evidence schema を強化する。
